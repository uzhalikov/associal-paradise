# Generated by Django 4.2.3 on 2023-09-22 14:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('user_recipient_id', models.TextField(blank=True, max_length=1000, null=True)),
                ('last_message', models.TextField(blank=True, max_length=1000, null=True)),
                ('status_message', models.BooleanField(blank=True, default=False, null=True)),
                ('time_create', models.DateTimeField(auto_now_add=True)),
                ('user_sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
