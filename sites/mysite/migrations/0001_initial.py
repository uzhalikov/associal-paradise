# Generated by Django 4.2.3 on 2023-09-05 18:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img', models.ImageField(blank=True, upload_to='mysite/static/images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(blank=True, upload_to='mysite/static/images/', verbose_name='Аватарка')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('was_read', models.BooleanField(blank=True, null=True)),
                ('private_img', models.ImageField(blank=True, null=True, upload_to='mysite/static/images/')),
                ('time_create', models.DateTimeField(auto_now_add=True)),
                ('time_update', models.DateTimeField(auto_now=True)),
                ('user_sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('msg', models.TextField(max_length=999999, verbose_name='')),
                ('msg_time_create', models.DateTimeField(auto_now_add=True)),
                ('msg_time_update', models.DateTimeField(auto_now=True)),
                ('msg_img', models.ImageField(blank=True, upload_to='mysite/static/images/', verbose_name='')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
